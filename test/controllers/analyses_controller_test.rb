...
class AnalysesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analysis" do
    assert_difference('Analysis.count') do
      post analyses_url, params: { analysis: { created_at: @analysis.created_at, field: @analysis.field, id: @analysis.id, title: @analysis.title, user_id: @analysis.user_id, videogame_id: @analysis.videogame_id } }
    end
  ...
  test "should update analysis" do
    patch analysis_url(@analysis), params: { analysis: { created_at: @analysis.created_at, field: @analysis.field, id: @analysis.id, title: @analysis.title, user_id: @analysis.user_id, videogame_id: @analysis.videogame_id } }
